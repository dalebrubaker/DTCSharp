...
public static class SierraChartUtil
{
    ...
    private static readonly Dictionary<string, SymbolSettings> s_symbolSettingsBySierraChartDirectoryAndSettingsFilename = new();
    private static readonly Dictionary<string, string> s_futuresSymbolPatternByPrefix = new();

    private static readonly object s_lock = new();

    private static readonly object s_lockFile = new();
