...
public class SymbolSettings
{
    ...
    private readonly Dictionary<string, XmlNode> _nodesBySymbol = new();

    private readonly Dictionary<string, XmlNode> _nodesBySymbolPattern = new();
    ...
    private static bool IsMatch(string symbolPattern, string symbol)
    {
        ...
        for (var i = 0; i < symbolPattern.Length; i++)
        {
