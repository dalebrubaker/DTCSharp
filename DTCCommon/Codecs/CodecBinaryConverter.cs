...
public static class CodecBinaryConverter
{
    ...
    private static byte[] ConvertToBufferSecurityDefinitionResponse(DTCMessageType messageType, SecurityDefinitionResponse securityDefinitionResponse)
    {
        ...
        bufferBuilder.Add(securityDefinitionResponse
            .RolloverDate); // DateTime4byte per  https://dtcprotocol.org/index.php?page=doc/DTCMessages_SymbolDiscoverySecurityDefinitionsMessages.php#Messages-SECURITY_DEFINITION_RESPONSE
